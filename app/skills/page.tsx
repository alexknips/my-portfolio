...
export default function Skills() {
  return (
    <div className=" bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 w-screen h-screen">
      <Navigation />
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-4 text-zinc-400">
            My skills roadmap can be explored in great detail at roadmap.sh.
      ...
      <div className="container mt-32 flex items-center justify-center px-4 mx-auto">
